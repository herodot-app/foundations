---
description: Open a pull request against main with a conventional title and description
---
...
If the user passed $ARGUMENTS, use it as-is (after silently fixing any typos).
